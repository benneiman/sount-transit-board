...
config = {
    ...
    "metro_hero_api_key": "",
    # Metro Station Codes
    "metro_station_codes": "1_8250",  # ['D05','F05'],
    # Metro Train Groups
    ...
    "walking_times": [2, 12],
    # WMATA API
    "wmata_api_url": "https://api.pugetsound.onebusaway.org/api/where/arrivals-and-departures-for-stop/",
    # # MetroHero API
    ...
    "aio_username": "bneiman",
    "aio_key": "nkreRtXJ?-=+F^3",
